...
<div style = "font-size:110%">
	...
	<table width=100% style = "margin:20px 0px; font-size:80%;">
		<tr>
			<td width="60%"><?php echo $atts['order']->get_formatted_billing_address() ?></td> <!-- Formatted billing address -->
			<td width="40%">
	...
	<table width=100% cellpadding="5" style = "border-collapse:collapse; margin:20px 0px; font-size:80%;">
		...
		foreach ($atts['cart'] as $item) { 
  		...
  		<tr>
  			...
  			<td align="center"><?php //echo $item['line_subtotal']; ?></td> -->
  		</tr>


		<?php } ?>
		<!-- <tr style="font-size:100%;"><th colspan=4 align="right">Total</th><th align="center"><?php //echo $atts['order']->get_total()?></th></tr> -->
