...
<div class="field-group fifty-fifty">
  <div class="form-group">
    <select class="form-group__input layout" id="<?php echo "{$this->prefix}__layout[legend][font][family]"; ?>" name="<?php echo "{$this->prefix}__layout[legend][font][family]"; ?>"  >
...
<div class="field-group fifty-fifty">
  <div class="form-group">
    <input type="number" class="form-group__input layout" id="<?php echo "{$this->prefix}__layout[legend][font][size]"; ?>" name="<?php echo "{$this->prefix}__layout[legend][font][size]"; ?>" value="<?php echo  $payload["chart"]["layout"]["legend"]["font"]["size"]; ?>" min="0" max="1000" step="1" >
  ...
  <div class="form-group">
    <input type="color" class="form-group__input form-group__input-color layout" id="<?php echo "{$this->prefix}__layout[legend][font][color]"; ?>" name="<?php echo "{$this->prefix}__layout[legend][font][color]"; ?>" value="<?php echo  $payload["chart"]["layout"]["legend"]["font"]["color"]; ?>" >
...
<div class="field-group fifty-fifty">
  ...
  <div class="form-group">
    <input type="number" class="form-group__input layout" id="<?php echo "{$this->prefix}__layout[legend][itemwidth]"; ?>" name="<?php echo "{$this->prefix}__layout[legend][itemwidth]"; ?>" value="<?php echo  $payload["chart"]["layout"]["legend"]["itemwidth"]; ?>" min="0" max="1000" step="1" >
...
<div class="field-group fifty-fifty">
  <div class="form-group">
    <input type="number" class="form-group__input layout" id="<?php echo "{$this->prefix}__layout[legend][x]"; ?>" name="<?php echo "{$this->prefix}__layout[legend][x]"; ?>" value="<?php echo  $payload["chart"]["layout"]["legend"]["x"]; ?>" min="-2" max="3" step=".01" >
  ...
  <div class="form-group">
    <input type="number" class="form-group__input layout" id="<?php echo "{$this->prefix}__layout[legend][y]"; ?>" name="<?php echo "{$this->prefix}__layout[legend][y]"; ?>" value="<?php echo  $payload["chart"]["layout"]["legend"]["y"]; ?>" min="-2" max="3" step=".01" >
