      ...
      <form id="<?php echo "{$this->prefix}__listChartsForm" ?>" class="form" action="#">
        ...
        if (!empty($payload)) :
          foreach($payload as $chart_id => $chart):
            ?>
            <div class="card" id="<?php echo "{$this->prefix}__chart__{$chart_id}__card"; ?>">
              ...
              <div class="card__footer">
                ...
                <div class="actions">
                  <a  href="<?php echo add_query_arg(array("page" => $this->prefix, "action" => "edit-chart", 'chartId' =>$chart_id), admin_url('admin.php')); ?>" title="Edit">
                    <svg class="edit" id='<?php echo "{$this->prefix}__editChart[{$chart_id}]" ?>'>
                      <use xlink:href="<?php echo "{$this->url}assets/img/icons.svg#icon-pencil"; ?>"></use>
                    </svg>
                  </a>
                  <a  href="<?php echo add_query_arg(array("page" => $this->prefix, "action" => "delete-chart", 'chartId' =>$chart_id), admin_url('admin.php')); ?>" title="Delete">
                    <svg class="delete" id='<?php echo "{$this->prefix}__deleteChart[{$chart_id}]" ?>'>
