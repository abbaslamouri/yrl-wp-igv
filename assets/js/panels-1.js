...
function createAccordionToggle(title) {
...
function createAccordionContent(id, cssClasses, panelIntroText = "", subPanelTitle) {
  ...
  if (panelIntroText && subPanelTitle) {   
...
function createAccordionSectionFields(fieldRows, subpanelContent, panelCssClasses, iwpgvObj) {
...
module.exports = { createAccordionToggle, createAccordionContent, createAccordionSectionFields, setFormGroup }
