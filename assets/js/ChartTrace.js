...
class ChartTrace extends ChartDefault {
  ...
  constructor(trace, spreadsheet, index, sheetId, chartType, iwpgvObj, colors, fontFamily) {

    super(colors, fontFamily);
  ...
  options() {
    ...
    return {
      ...
      hoverlabel : {
        bgcolor: ( this.trace.hoverlabel === undefined || this.trace.hoverlabel.bgcolor === undefined ) ? "#eee" : this.trace.hoverlabel.bgcolor,
      ...
      fields : [
        ...
        [
          ...
          },
          {
            ...
            readOnly: this.options().error_y.symmetric ? true : false,
        ...
        [
          ...
          },
          {
            ...
            title : "Error Bar Line Rhickness", 
            type : "number",
            min : 1,
            max : 1000,
            step : 1,
        ...
        [
          {
            ...
            value : this.options().error_y.align,
