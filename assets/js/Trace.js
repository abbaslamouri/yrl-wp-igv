class Trace {
  ...
  sections() {
    ...
    return {
            ...
            inputFields: [
              {
                ...
                max : 300,
                step : 1,
                value :  this.trace.marker.symbol,
            ...
            inputFields: [
              {
                ...
                max : 1,
                step : .01,
                value :  this.trace.marker.opacity,
                disabled: ( false == this.trace.visible || ! this.trace.mode.includes( "marker" ) )  ? true : false,
            ...
            inputFields: [
              {
                ...
                type : "color",
                value :  this.trace.marker.line.color,
                disabled: ( false == this.trace.visible || ! this.trace.mode.includes( "marker" ) )  ? true : false,
              ...
              },
              {
                ...
                max : 100,
                step : 1,
                value :  this.trace.marker.line.width,
                disabled: ( false == this.trace.visible || ! this.trace.mode.includes( "marker" ) )  ? true : false,
            ...
            inputFields: [
              {
                ...
                value :  this.trace.marker.gradient.type,
                disabled: ( false == this.trace.visible || ! this.trace.mode.includes( "marker" ) )  ? true : false,
              ...
              },
              {
                ...
                type : "color",
                value :  this.trace.marker.gradient.color,
                disabled: ( false == this.trace.visible || ! this.trace.mode.includes( "marker" ) )  ? true : false,
      ...
      //           max : 20000,
      //           step : 1,
      //           value :  this.trace.marker.maxdisplayed,
      //           disabled: ( false == this.trace.visible || ! this.trace.mode.includes( "marker" ) )  ? true : false,
      ...
      //           max : 1.3,
      //           step : 0.01,
      //           value :  this.trace.line.smoothing,
      //           disabled: ( true !== this.trace.visible || ! this.trace.mode.includes( "lines" ) )  ? true : false,
      ...
      //           title : "line Simplify", 	
      //           type : "checkbox",
      //           value :  this.trace.line.simplify,
      //           disabled: ( true !== this.trace.visible || ! this.trace.mode.includes( "lines" ) )  ? true : false,
      ...
      //           title : "Text", 	
      //           type : "text",
      //           value :  Array.isArray( this.options( ).text ) ? this.trace.text.join() : this.trace.text,
      //           disabled: true !== this.trace.visible  ? true : false,
      ...
      //           type : "select",
      //           options : fontFamily(),
      //           value : this.trace.textfont.family,
      //           disabled: true !== this.trace.visible  ? true : false,
      ...
      //           type : "color", 
      //           value : this.trace.textfont.color,
      //           disabled: true !== this.trace.visible  ? true : false,
      //         }, 
      //         {
      ...
      //           max : 100,
      //           step : 0.5,
      //           value : this.trace.textfont.size,
      //           disabled: true !== this.trace.visible  ? true : false,
      ...
      //           title : "Hover Text", 	
      //           type : "text",
      //           value :  Array.isArray( this.trace.hovertext ) ? this.trace.hovertext.join() : this.trace.hovertext,
      //           disabled: true !== this.trace.visible  ? true : false,
      ...
      //             right : "Right",
      //           },
      //           value : this.trace.hoverlabel.align,
      //           disabled: true !== this.trace.visible  ? true : false,
      ...
      //           max : 1000,
      //           step : 1,
      //           value : this.trace.hoverlabel.namelength,
      //           disabled: true !== this.trace.visible  ? true : false,
      ...
      //           type : "select",
      //           options : fontFamily(),
      //           value : this.trace.hoverlabel.font.family,
      //           disabled: true !== this.trace.visible  ? true : false,
      //           hint: "HTML font family - the typeface that will be applied by the web browser. The web browser will only be able to apply a font if it is available on the system which it operates. These include 'Arial', 'Balto', 'Courier New', 'Droid Sans',, 'Droid Serif', 'Droid Sans Mono', 'Gravitas One', 'Old Standard TT', 'Open Sans', 'Overpass', 'PT Sans Narrow', 'Raleway', 'Times New Roman'."
      //         },
      //         {
      ...
      //           max : 100,
      //           step : 0.5,
      //           value : this.trace.hoverlabel.font.size,
      //           disabled: true !== this.trace.visible  ? true : false,
      //           hint : "number greater than or equal to 1"
      //         },
      //       ],
      ...
      //           type : "color", 
      //           value : this.trace.hoverlabel.font.color,
      //           disabled: true !== this.trace.visible  ? true : false,
      //         },
      //         {
      ...
      //           type : "color", 
      //           value : this.trace.hoverlabel.bgcolor,
      //           disabled: true !== this.trace.visible  ? true : false,
      ...
      //           type : "color", 
      //           value : this.trace.hoverlabel.bordercolor,
      //           disabled: true !== this.trace.visible  ? true : false,
      ...
      //           title : "Show Error",	
      //           type : "checkbox",
      //           value : this.trace.error_y.visible,
      //           disabled: true !== this.trace.visible  ? true : false,
      ...
      //           title : "Value",
      //           type : "number", 
      //           value : this.trace.error_y.value,
      ...
      //           title : "Value Minus",
      //           type : "number", 
      //           value : this.trace.error_y.valueminus,
      ...
      //           title : "Error Array",	
      //           type : "text",
      //           value : this.trace.error_y.array.join(),
      //           disabled: ( ! this.trace.error_y.visible || this.trace.error_y.type !== "data" || true !== this.trace.visible ) ? true : false,
      ...
      //           type : "text",
      //           value : this.trace.error_y.arrayminus.join(),
      //           disabled: ( ! this.trace.error_y.visible || this.trace.error_y.type !== "data" || this.trace.error_y.symmetric || true !== this.trace.visible ) ? true : false,
      ...
      //           type : "color", 
      //           value : this.trace.error_y.color,
      //           disabled: ( ! this.trace.error_y.visible || true !== this.trace.visible )? true : false,
      ...
      //           title : "Symmetric ?",
      //           type : "checkbox", 
      //           value : this.trace.error_y.symmetric,
      //           disabled: ( ! this.trace.error_y.visible || true !== this.trace.visible ) ? true : false,
      ...
      //           max : 1000,
      //           step : 1,
      //           value : this.trace.error_y.width,
      //           disabled: ( ! this.trace.error_y.visible || true !== this.trace.visible )  ? true : false,
      ...
      //           max : 1000,
      //           step : 1,
      //           value : this.trace.error_y.thickness,
      //           disabled:  ( ! this.trace.error_y.visible || true !== this.trace.visible )  ? true : false,
