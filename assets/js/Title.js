        ...
        fieldGroups : [
          {
            ...
            inputFields: [
              ...
              },
              {
                ...
                title : "Font Color",
                type : "color", 
                value : layout.title.font !== undefined && layout.title.font.color !== undefined ? layout.title.font.color : this.defaultOptions().title.font.color,
            ...
            inputFields: [
              {
                ...
                type : "select",
                options : fontFamily(),
                value : layout.title.font !== undefined && layout.title.font.family !== undefined ? layout.title.font.family : this.defaultOptions().title.font.family,
                disabled: ! layout.title.text  ? true : false,
              ...
              },
              {
                ...
                max : 100,
                step : 0.5,
                value : layout.title.font !== undefined && layout.title.font.size !== undefined ? layout.title.font.size : this.defaultOptions().title.font.size,
                disabled: ! layout.title.text  ? true : false,
            ...
            inputFields: [
              {
                ...
                max : 1,
                step : 0.01,
                value : layout.title.x ? layout.title.x : this.defaultOptions().title.x,
                disabled: ! layout.title.text  ? true : false,
              ...
              },
              {
                ...
                max : 1,
                step : 0.01,
                value : layout.title.y ? layout.title.y : this.defaultOptions().title.y,
                disabled: ! layout.title.text  ? true : false,
