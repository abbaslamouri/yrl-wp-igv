...
if (!class_exists('ChartLayout')) {
    ...
    public function layout() {
			...
			return [ 
				...
				"title" => [
					"text" => isset( $this->layout['title']['text'] ) ? $this->layout['title']['text'] : 'Hi There',
					"x"    => isset( $this->layout['title']['x'] ) ? $this->layout['title']['x'] : 0.5,
					"y"    => isset( $this->layout['title']['y'] ) ? $this->layout['title']['y'] : 0.9,
					"font" => [
						"family" => isset( $this->layout['title']['font']['family'] ) ? $this->layout['title']['font']['family'] : 'Balto',
				...
				"showlegend" => isset( $this->layout['showlegend'] ) ? $this->layout['showlegend'] : true,
				"legend" => [
					"bgcolor" => isset( $this->layout['legend']['bgcolor'] ) ? $this->layout['legend']['bgcolor'] : 'yellow',
					"bordercolor" => isset( $this->layout['legend']['bordercolor'] ) ? $this->layout['legend']['bordercolor'] : 'green',
					"borderwidth" => isset( $this->layout['legend']['borderwidth'] ) ? $this->layout['legend']['borderwidth'] : 2,
					"font" => [
						"family" => isset( $this->layout['legend']['font']['family'] ) ? $this->layout['legend']['font']['family'] : 'Raleway',
						"size" => isset( $this->layout['legend']['font']['size'] ) ? $this->layout['legend']['font']['size'] : 20,
						"color" => isset( $this->layout['legend']['font']['color'] ) ? $this->layout['legend']['font']['color'] : "red",
					],
					"orientation" => isset( $this->layout['legend']['orientation'] ) ? $this->layout['legend']['orientation'] : 'h',
				],
				"xaxis" => [
        ...
        "chartLayout" => [
              ...
              'intro' => "lorem udfujdfsjsdj",
							...
							"title" => __("hhhhh", $this->plugin),
							"fields" => [
                [
									[
										"id" => "chartLayout[paper_bgcolor]",
										"title" => __("Paper Color Color", $this->plugin),
										"type" => "color-picker", 
										"cssClasses" => ["color-picker"],
										"value" => $this->layout()['paper_bgcolor'],
									],
									...
									[
										...
										"type" => "color-picker", 
										"cssClasses" => ["color-picker"],
										"value" => $this->layout()['plot_bgcolor'],
									],
								],
								[
									[
                ...
                [
                    ...
                    "step" => 1,
						...
						// "chartTitle" => [
						// 	"id" => "{$this->prefix}__chartLayoutPanel__chartTitle",
						// 	"title" => "Chart Title",
						// 	"fields" => [
						// 		[
						// 			[
            ...
            //         "step" => 1,
						...
						// "chartArea" => [
						// 	"id" => "{$this->prefix}__chartLayoutPanel__chartArea",
						// 	"title" => "Chart Area",
						// 	"fields" => [
						// 		[
						// 			[
