		...
		public function chart_library() {
			...
			if ( ! isset($_GET['action']) ) {
				...
				foreach ($saved_charts as $chart_id => $chart) {
					...
					// Display Template
				echo $this->get_template_html("chart-library", $charts);
        ...
        try {
          ...
          $chart = [
            ...
            "chartTraces" => []
				...
				// Set chart params and fields
				// $chart_params_instance = new ChartParams(  );
				// $panels = array_merge($panels, $chart_params_instance->fields());
				// print_r($panels);die;
	
				// // Set chart options and fields
				// $chart_options_instance = new ChartOption(   );
				// $panels = array_merge($panels, $chart_options_instance->fields());

				// // Set pie chart options and fields
				// $pie_Chart_options_instance = new PieChartOption();
				// $panels = array_merge($panels, $pie_Chart_options_instance->fields());

				// // Set horizontal axis options and fields
				// $axis_params = ['id' => 'horAxisOption' , 'axis' =>'[hAxis]', 'panelId' =>'horizontalAxis', 'title' => 'Horzontal Axis'];
				// $hor_axis_options_instance = new AxisOption([], $axis_params);
				// $panels = array_merge($panels, $hor_axis_options_instance->fields( ));
				
	
				// // Set left vertical options axis fields
				// $axis_params = ['id' => 'leftAxisOption' , 'axis' =>'[vAxes][0]', 'panelId' =>'leftAxis', 'title' => 'Left Axis'];
				// $left_axis_options_instance = new AxisOption([], $axis_params);
				// $panels = array_merge($panels,$left_axis_options_instance->fields( ));

				// // Set right vertical axis options and fields
				// $axis_params = ['id' => 'rightAxisOption' , 'axis' =>'[vAxes][1]', 'panelId' =>'rightAxis', 'title' => 'Right Axis'];
				// $right_axis_options_instance = new AxisOption([], $axis_params);
				// $panels = array_merge($panels, $right_axis_options_instance->fields( ));
