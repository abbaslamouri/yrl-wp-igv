...
if (!class_exists('File')) {
	...
	class File {
		...
		function __construct() {
			...
			$this->max_file_size = 3*1024*1024;	// 3 MB
		...
		*/
		public function create_db_table() {
			...
			$sql = "CREATE TABLE $this->db_table (
				...
				design_min real(9,3) DEFAULT 0 NOT NULL,
				design_max real(9,3) DEFAULT 0 NOT NULL,
				design_center real(9,3) DEFAULT 0 NOT NULL,
				design_type varchar(20) DEFAULT '' NOT NULL,
				substrate varchar(50) DEFAULT '' NOT NULL,
