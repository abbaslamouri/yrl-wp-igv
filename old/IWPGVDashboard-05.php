...
if (!class_exists('IWPGVDashboard')) { 
	class IWPGVDashboard {
		...
		public $default_file_name = "pie-chart.xlsx";
		public $default_chart_type = "PieChart";
			...
			try {
				...
				foreach ($this->admin_fields() as $option_group_id => $option_group) {
					...
					foreach($option_group["options"] as $option => $field) {
						...
						if (isset($field["uniqueTo"])) {
							$unique_fields[$field["id"]] = $field["uniqueTo"];
						}
					}
...
// }
		...
		*/
		...
		function admin_fields_metaboxes_render($chart, $sheet) {
			...
			?><div id ="dashbboard-admin-fields">
				...
				foreach($this->admin_settings() as $setting_group) {
					?>
						...
						<button  id="<?php echo $setting_group["section"] ?>" class ="main"><?php echo $setting_group["title"] ?></button>
						<div class = "panel <?php echo $setting_group["section"] ?>" >
							<div class = "subPanel" >
								<div class ="accordion" class = "">
							<?php
							...
							foreach ($setting_group["subsections"] as $subsection) {
								?>
									...
									<?php if (count($setting_group["subsections"]) != 1) :?>
										
										<button class ="secondary" ><?php echo $subsection["title"] ?></button>
									...
									<?php 
										...
										if (count($setting_group["subsections"]) != 1) :?>
			...
			</div><!-- #dashbboard-admin-fields --><?php
...
return $html;
		...
		*/
		...
		public function pie_chart_default_options($fields) {
					...
					"subsections" => array(
						array(
							...
							"fields" => array(
								...
								array(
									//"slug" => chart_title, // field id
									"id" => "title.Position",  // id attribute if the field
									...
									"nullOption" => "Chart Title Position",
									"uniqueTo" => array(
										"Line"
									),
									//description => Enable Custom Post Types, // Custom field description(supplied in the $args)
						...
						array(
							...
							"fields" => array(
								...
								array(
									...
									"fieldTitle" => __("Chart Area Top", $this->plugin), // Formatted title of the field. Shown as the label for the field during output.
									"submenuPage" => "{$this->prefix}_dashboard", // Section to which this field belongs
									//"section" => "chartSettings",
									"fieldType" => "text", // custom field (fieled\\d type:  text, email, checkbox, textarea....) (supplied in the $args)
									//description => Enable Custom Post Types, // Custom field description(supplied in the $args)
								...
								array(
									...
									"fieldTitle" => __("Chart Area Left", $this->plugin), // Formatted title of the field. Shown as the label for the field during output.
									"submenuPage" => "{$this->prefix}_dashboard", // Section to which this field belongs
									//"section" => "chartSettings",
									"fieldType" => "text", // custom field (fieled\\d type:  text, email, checkbox, textarea....) (supplied in the $args)
									//description => Enable Custom Post Types, // Custom field description(supplied in the $args)
						...
						array(
							...
							"fields" => array(
								array(
									...
									"cssClass" => "color-picker",
									"fieldTitle" => __("Tooltip Text Color", $this->plugin), // Formatted title of the field. Shown as the label for the field during output.
									"submenuPage" => "{$this->prefix}_dashboard", // Section to which this field belongs
									"section" => "chartSettings",
									"fieldType" => "color-picker", // custom field (fieled\\d type:  text, email, checkbox, textarea....) (supplied in the $args)
									//description => Enable Custom Post Types, // Custom field description(supplied in the $args)
								...
								array(
									...
									"fieldTitle" => __("Tooltip Font", $this->plugin), // Formatted title of the field. Shown as the label for the field during output.
									"submenuPage" => "{$this->prefix}_dashboard", // Section to which this field belongs
									"section" => "chartSettings",
									"fieldType" => "select", // custom field (fieled\\d type:  text, email, checkbox, textarea....) (supplied in the $args)
									"fieldOptions" => array(
								...
								array(
									...
									"fieldTitle" => __("Tooltip Trigger", $this->plugin), // Formatted title of the field. Shown as the label for the field during output.
									"submenuPage" => "{$this->prefix}_dashboard", // Section to which this field belongs
									"section" => "chartSettings",
									"fieldType" => "select", // custom field (fieled\\d type:  text, email, checkbox, textarea....) (supplied in the $args)
									"fieldOptions" => array(
										...
										"selection" => "The tooltip will be displayed when the user selects the elemen",
									),
									"nullOption" => "Select Font",
									//description => Enable Custom Post Types, // Custom field description(supplied in the $args)
									//value => (isset($settings) && isset($settings[chart_title])) ? $settings[chart_title] : "",
								...
								array(
									...
									"fieldTitle" => __("Tooltip Font Size", $this->plugin), // Formatted title of the field. Shown as the label for the field during output.
									"submenuPage" => "{$this->prefix}_dashboard", // Section to which this field belongs
									"section" => "chartSettings",
									"fieldType" => "text", // custom field (fieled\\d type:  text, email, checkbox, textarea....) (supplied in the $args)
									"default" => 30
								...
								array(//"slug" => "chart_title", // field id
									...
									"fieldTitle" => __("Tool Tip Text", $this->plugin), // Formatted title of the field. Shown as the label for the field during output.
									"submenuPage" => "{$this->prefix}_dashboard", // Section to which this field belongs	
									"fieldType" => "select", // custom field (fieled\\d type:  text, email, checkbox, textarea....) (supplied in the $args)
									"fieldOptions" => array(
										"both" => "Display both the absolute value of the slice and the percentage of the whole",
								...
								array(
									...
									"fieldTitle" => __("Tooltip Show Color Code", $this->plugin), // Formatted title of the field. Shown as the label for the field during output.
									"submenuPage" => "{$this->prefix}_dashboard", // Section to which this field belongs
									"section" => "chartSettings",
									"fieldType" => "checkbox", // custom field (fieled\\d type:  text, email, checkbox, textarea....) (supplied in the $args)
									//description => Enable Custom Post Types, // Custom field description(supplied in the $args)
