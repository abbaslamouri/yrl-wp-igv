		...
		$.each(allInputs, function(i,input) {
			...
			if (!! inputId && inputId.includes("chart")) {
				...
				// Toggle series.i.pointShape.type, pointShape.sides, pointShape.dent, pointSize, pointShape.rotation, based on series.i.pointsVisible, 
					...
					chartPointsOptions = [".pointSize", ".pointShape.sides", ".pointShape.dent", ".pointShape.rotation"];
					...
					$(input).change(function() {
						...
						$.each(chartPointsOptions, function (i, option) {
							...
							// input fields
							inputLoadChangeEventHandler( $("#iwpgv-dashboard input[id='" + seriesPointOptionId + option + "']"), DisableCondition );
						});
				...
				//Toggle series.i.pointShape.sides, pointShape.dent based on pointShape.type 
					...
					$.each(chartPointsOptions, function (i, option) {
						...
						// input fields
						inputLoadChangeEventHandler( $("#iwpgv-dashboard input[id='" + seriesPointOptionId + option + "']"), inputValue == "star" );
					});
					...
					$(input).change(function() {
						...
						$.each(chartPointsOptions, function (i, option) {
							...
							// input fields
							inputLoadChangeEventHandler( $("#iwpgv-dashboard select[id='" + seriesPointOptionId + option + "']"), DisableCondition == "star" );
						});
